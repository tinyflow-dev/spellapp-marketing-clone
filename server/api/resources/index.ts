...
export default defineEventHandler(async (event) => {
    ...
    try {
        ...
        console.log("[Resources API] hit with page:", page, "| offset:", offset, "| Found resources:", resources.length, "| Total:", total);
        console.log("[Resources API] received page from query:", query.page);
        ...
        console.error("[Resources API] DB error:", err);
        return {
            resources: [],
            pagination: {
                page,
